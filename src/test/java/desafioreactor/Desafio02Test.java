...
public class Desafio02Test {
    ...
    @Test
    void hasNoAdmin(){
        StepVerifier.create(desafio02.countAdmins(generateUsers((long) faker.number().randomDigitNotZero(), false)))
    ...
    void hasXAdmins(){
        ...
        StepVerifier.create(desafio02.countAdmins(Stream.concat(noAdminUsers.stream(), adminUsers.stream()).toList()))
                .recordWith(ArrayList::new)
                .thenConsumeWhile(actual -> true)
